...
class Info(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction):
        ...
        """
        embed = discord.Embed(
            title=f"{settings.bot_name} Discord bot", color=discord.Colour.red()
        )

        try:
            balls = await self._get_6_balls_emojis()
        except Exception:
        ...
        embed.description = (
            ...
            "This bot was made by **OJ** by using **El Laggron's** script, consider supporting me on my "
            "[Patreon](https://www.patreon.com/Bengaldex) :heart:\n\n"
